    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 flex justify-center items-center">
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-xl flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-8">
          <h2 className="text-3xl font-semibold text-blue-500 mb-1">Workshops</h2>
          <p className="text-sm text-gray-500 mb-6">Only for College / University Administration</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Domain for Workshop</label>
              <select
                name="domain"
